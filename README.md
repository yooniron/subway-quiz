...
<!-- RELEASE_LOGS_START -->
- feat: feature/27-refactor-modular-architecture 모듈화 리팩토링 및 확정형 컴포넌트/디렉토리 구조화 (#9) (2026-07-21)
- refactor: 🛠️ 모듈화 리팩토링 및 미래 확장형 컴포넌트/디렉터리 구조화 구현 (#27) (2026-07-21)
- feat: feature/26-auto-focus-input 퀴즈 제출 및 전환 시 인풋창 자동포커스 안되던 버그 수정  (#8) (2026-07-20)
- feat: 🎯 퀴즈 제출 및 전환 시 인풋창 자동 포커스(Auto-Focus) 유지 기능 구현 (#26) (2026-07-20)
- feat: 싱글 타임어택 (60초 챌린지) 모드 및 전역 랭킹 시스템 구축 & README 반영 (#6) (2026-07-20)
