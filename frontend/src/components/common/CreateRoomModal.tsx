...
import { PlusCircle, X, Check, Dices } from 'lucide-react';
import { SUBWAY_LINES } from './LineSelectorModal';

interface CreateRoomModalProps {
    isOpen: boolean;
    onClose: () => void;
    onCreateRoom: (roomTitle: string, selectedLineIds: number[]) => void;
}
...
export const CreateRoomModal: React.FC<CreateRoomModalProps> = ({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onCreateRoom(cleanTitle, selectedLineIds);
        onClose();
    };
            ...
            <div className="relative w-full max-w-md bg-gray-900 border border-gray-800 rounded-3xl p-6 shadow-2xl animate-card-pop">
                ...
                <div className="flex items-center gap-2.5 mb-5">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">방 제목과 출제될 호선을 설정하세요</p>
                    </div>
                </div>
