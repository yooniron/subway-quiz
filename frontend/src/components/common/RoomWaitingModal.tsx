...
import { Users, Crown, CheckCircle2, Clock, Copy, LogOut, Zap, Sparkles, Lightbulb, Key, Ticket } from 'lucide-react';
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                            ...
                            {inviteCode && (
                                <button
                                    ...
                                    className="px-2.5 py-0.5 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-400 hover:text-purple-300 text-[10px] font-mono font-bold flex items-center gap-1 transition-colors"
                                    title="초대 코드 복사"
                                >
                                    <Key className="w-3 h-3 text-purple-400" /> 코드: {inviteCode}
                                </button>
                            )}
                        </div>
                ...
                <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex gap-1.5">
                        {inviteCode && (
                            <button
                                onClick={handleCopyInviteCode}
                                className="px-3 py-2 rounded-xl bg-gray-950 border border-gray-800 hover:border-purple-400/40 text-xs font-bold text-purple-400 flex items-center gap-1.5 transition-colors active:scale-95"
                            >
                                <Ticket className="w-3.5 h-3.5" /> 코드 복사
                            </button>
                        )}
                        <button
