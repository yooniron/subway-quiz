...
- refactor: Dissect 및 Multi-Review 기반 CRITICAL 결함 5건 및 핵심 UX/보안 종합 수정 (2026-07-23)
- feat: 공개/비공개 방 설정(비밀번호) 및 6자리 초대코드 대전방 직통 입장 기능 구축 (2026-07-23)
- feat: 대기실 실시간 1대1 이모지 말풍선(Speech Bubble) 연출 구현 (2026-07-23)
- fix: 초대링크 복사 실패, 모달 겹침 및 재경기 이탈 동기화 오류 수리 (2026-07-22)
