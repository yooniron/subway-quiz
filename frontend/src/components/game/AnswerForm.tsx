...
export const AnswerForm: React.FC<AnswerFormProps> = ({
    ...
    return (
        <form onSubmit={onSubmit} className="flex gap-2 max-w-sm mx-auto relative mt-6">
            <input
                ref={inputRef}
                autoFocus
                type="text"
            ...
            <button 
                type="submit"
                disabled={disabled}
                className="px-6 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-black rounded-xl transition-all transform active:scale-95 shadow-md flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
