...
<!-- RELEASE_LOGS_START -->
- refactor: 🛠️ 모듈화 리팩토링 및 미래 확장형 컴포넌트/디렉터리 구조화 구현 (2026-07-21)
- feat: 🎯 퀴즈 제출 및 전환 시 인풋창 자동 포커스(Auto-Focus) 유지 기능 구현 (2026-07-20)
- feat: 🎯 싱글 타임어택 (60초 챌린지) 모드 및 🏆 전역 랭킹 시스템 구축 (2026-07-20)
