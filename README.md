...
- feat: 4지선다 카드 스피드 연습 모드 개발 및 호선 선택 필터 기능 연동 (2026-07-28)
- feat: UI Pro Max 디자인 시스템 개편, SQL 멱등성 42710/42P13 에러 방지, DDL 컬럼 마이그레이션 및 CorrectOverlay 팝업 연출 보강 (2026-07-27)
<!-- RELEASE_LOGS_END -->
